...
public:
	LineMaker()
	{
		shader = new Shader(Effects + L"052_Line.hlsl");
	...
	void DrawLine(int path)
	{
		...
		shader->AsMatrix("World")->SetMatrix(lineWorld);
		shader->AsVector("Color")->SetFloatVector(lineColor);

		shader->DrawIndexed(0, path, indexCount);
	}
	////////////////////////////////////////////////////////////////////////////////////////
