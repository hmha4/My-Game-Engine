...
void MeshCube::CreateData()
{
	...
	vertices.push_back(VertexTextureNormalTangent(+w, -h, -d, 0, 0, 0, -1, 0, 0, 0, 1));
	vertices.push_back(VertexTextureNormalTangent(+w, -h, +d, 1, 0, 0, -1, 0, 0, 0, 0));
	vertices.push_back(VertexTextureNormalTangent(-w, -h, +d, 1, 1, 0, -1, 0, 0, 1, 0));
