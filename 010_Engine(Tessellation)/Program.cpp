...
#include "./Executes/TessTriangle.h"
#include "./Executes/TessTriangleLOD.h"
#include "./Executes/TessRect.h"
#include "./Executes/TessRectLOD.h"
...
Program::Program()
{
	...
	executes.push_back(new TessTriangle());
	executes.push_back(new TessTriangleLOD());
	executes.push_back(new TessRect());
	executes.push_back(new TessRectLOD());
}
