...
private:
	//	Variables for Adjusting HeightMap
	Effect * brushEffect;
	ID3D11ShaderResourceView*srv;
	ID3D11UnorderedAccessView*uav;

	//	Variables for Saving HeightMap
	Effect * saveHeightMapEffect;
	ID3D11Buffer * saveBuffer;
	ID3D11UnorderedAccessView * saveUAV;
...
private:
	...
	ID3DX11EffectScalarVariable * brushPowerVar;
	ID3DX11EffectVectorVariable * pixelPositionVar;
	ID3DX11EffectScalarVariable * brushValueVar;
};