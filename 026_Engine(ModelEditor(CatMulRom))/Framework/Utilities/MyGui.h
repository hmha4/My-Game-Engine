...
public:
	...
	static void FPSPlot();
	static void ShowSkySetting(class ScatterSky * sky);
	static void ShowLightSetting(class Context * context);
	static void ShowCameraSetting(class Context * context);
...
public:
	...
	static bool show_app_behaviour;
	static bool show_app_debugLog;
	static bool show_app_modal;
	static bool show_app_retarget;

private:
	static void ChangeTexture(wstring fileName, class ScatterSky * sky, UINT type);
...
public:
	struct ExampleAppLog
	{
		...
		void    Draw(const char* title, bool* p_open = NULL)
		{
			...
			if (!ImGui::Begin(title, p_open, ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoMove))
			{
				ImGui::End();
				return;
			}
