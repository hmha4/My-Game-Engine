...
public:
	...
	//  Effect
	// --------------------------------------------------------------------- //
	ID3DX11EffectMatrixVariable * GetWorldVariable() { return worldVar; }
	Effect *GetEffect() { return effect; }	//  Get the shader file
...
private:
	...
	ID3DX11EffectShaderResourceVariable * diffuseVar;
	ID3DX11EffectShaderResourceVariable * specularVar;
	ID3DX11EffectShaderResourceVariable * normalVar;
	ID3DX11EffectShaderResourceVariable * detailVar;
