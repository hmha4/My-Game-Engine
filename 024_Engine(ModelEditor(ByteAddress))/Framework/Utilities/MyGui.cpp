...
void MyGui::ChangeTexture(wstring fileName, ScatterSky * sky, UINT type)
{
	...
	case 0:
	{
		...
		sky->GetEffect()->AsShaderResource("StarfieldMap")->SetResource(sky->GetStarFieldMap()->SRV());
	}
	break;
	case 1:
	{
		...
		sky->GetEffect()->AsShaderResource("MoonMap")->SetResource(sky->GetMoonMap()->SRV());
	}
	break;
	case 2:
	{
		...
		sky->GetEffect()->AsShaderResource("MoonGlowMap")->SetResource(sky->GetGlowMap()->SRV());
	}
	break;
	case 3:
	{
		...
		sky->GetEffect()->AsShaderResource("CloudMap")->SetResource(sky->GetCloudMap()->SRV());
	}
	break;
	}
