...
void TerrainRenderer::Ready(Material*material)
{
	...
	effect->AsShaderResource("HeightMap")->SetResource(heightMapSRV);
	effect->AsShaderResource("LayerMapArray")->SetResource(layerMapArraySRV);
	effect->AsShaderResource("BlendMap")->SetResource(blendMapSRV);
...
{
	effect->AsShaderResource("HeightTexture")->SetResource(heightMapSRV);
...
void TerrainRenderer::Render()
{
	...
	hr = material->GetEffect()->AsConstantBuffer("CB_Terrain")->SetConstantBuffer(cBuffer);
	assert(SUCCEEDED(hr));
	...
	material->GetEffect()->AsMatrix("World")->SetMatrix(world);
