...
//===========================Geometry=========================//
Geometry::Geometry(XYZAxis axis, Effect*effect, Effect*line, int TransModel)
...
void Geometry::Render()
{
	...
	if (axisType == XYZAxis::XAxis || axisType == XYZAxis::YAxis || axisType == XYZAxis::ZAxis)
	{
		...
		effect->AsVector("Color")->SetFloatVector(gizmoColor);
