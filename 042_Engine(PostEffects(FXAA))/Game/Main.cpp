...
#include "Executes/TestDeferred.h"
...
void Main::Initialize()
{
	...
	//Push(new TestDeferred());
	SceneManager::Get()->InputScene(SceneManager::SCENETYPE::MainScene, new TestDeferred());
	...
	SceneManager::Get()->InputScene(SceneManager::SCENETYPE::Default, new DefaultScene());
