...
private:
	...
	void BoxInit();
public:
	GizmoGeometry(XYZAxis axis, Effect*effect, class Effect*line, int TransModel = 1);
	virtual ~GizmoGeometry();
...
//피킹기능 추가해야함
//모델에 해당하는 라인그리는것도 추가
class Geometry_Scale :public GizmoGeometry
{
public:
	Geometry_Scale(XYZAxis axis, Effect*effect, class Effect*line, GizmoType gizmoType);
	~Geometry_Scale();
...
class Geometry_Rotate :public GizmoGeometry
{
public:
	Geometry_Rotate(XYZAxis axis, Effect*effect, class Effect*line, GizmoType gizmoType);
	~Geometry_Rotate();
...
class Geometry_Trans :public GizmoGeometry
{
public:
	Geometry_Trans(XYZAxis axis, Effect*effect, class Effect*line, GizmoType gizmoType);
	~Geometry_Trans();
...
class Geometry_Plane :public GizmoGeometry
{
public:
	Geometry_Plane(XYZAxis axis, Effect*effect, class Effect*line, GizmoType gizmoType);
	~Geometry_Plane();
...
class Geometry_Line :public GizmoGeometry
{
public:
	Geometry_Line(XYZAxis axis, Effect*effect, class Effect*line, GizmoType gizmoType);
	~Geometry_Line();
...
class Geometry_Box :public GizmoGeometry
{
public:
	Geometry_Box(XYZAxis axis, Effect*effect, class Effect*line, GizmoType gizmoType);
	~Geometry_Box();
