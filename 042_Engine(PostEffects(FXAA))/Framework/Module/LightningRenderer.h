...
private:
	...
	void BuildDownSampleBuffers(UINT width, UINT height, DXGI_SAMPLE_DESC sampleDesc);
	...
	void DrawQuad(UINT tech, UINT pass);
...
private:
	...
	vector<SIZE>					m_down_sample_buffer_sizes;
	vector<ColorRenderBuffer*>		m_down_sample_buffers;
