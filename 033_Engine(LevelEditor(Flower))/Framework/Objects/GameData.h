...
struct GameTerrainSpec : public GameDataSpec
{
	...
	struct FlowerDesc
	{
		wstring FlowerDiffuseMap = L"";

		UINT FlowerNum = 0;
		UINT FlowerSize = 0;
		UINT NumOfRoots = 0;

		D3DXVECTOR3 FlowerPosition = D3DXVECTOR3(0, 0, 0);

		FlowerDesc() {}
	};

	vector<FlowerDesc> flowerDesc;
...
private:
	...
	vector<GameDataSpec *> specList;
	vector<GameDataSpec *>::iterator specListIter;
};