...
private:
	struct GizmoAxisModel
	{
		...
		GizmoGeometry*xAxisModel;
		GizmoGeometry*yAxisModel;
		GizmoGeometry*zAxisModel;
		GizmoGeometry*XZPlane;
		GizmoGeometry*XYPlane;
		GizmoGeometry*YZPlane;
		GizmoGeometry*xLine;
		GizmoGeometry*yLine;
		GizmoGeometry*zLine;
		GizmoGeometry*xBoundingBox;
		GizmoGeometry*yBoundingBox;
		GizmoGeometry*zBoundingBox;
