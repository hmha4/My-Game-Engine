...
#include "./Executes/TestReflreation.h"
#include "./Executes/TestDynamicCubeMapping.h"
...
Program::Program()
{
	...
	//executes.push_back(new TestReflreation());
	executes.push_back(new TestDynamicCubeMapping());
}
